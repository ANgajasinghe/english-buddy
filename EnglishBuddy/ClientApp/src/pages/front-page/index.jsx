                ...
                <div className="shadow-sm py-2">
                    <div className="grid grid-cols-5">
                        <div className="px-10 col-span-3 py-40">
                            <div><span className="font-extrabold text-8xl text-yellow-500">ENGLISH</span><span className="font-extrabold text-8xl text-blue-600"> BUDDY</span></div>
                            <span className="font-bold text-5xl py-18">World <span className="font-extrabold text-6xl text-yellow-500">#1</span> Online English Learning Platform</span>
                            ...
                            <div className="flex"><div className="mr-7"><Button variant="contained" size="large" color="primary">SIGN UP NOW</Button></div>
                ...
                <div className="grid grid-cols-6 gap-4 py-6">
                    <div class="col-start-2 col-span-4">
                        ...
                        <p className="text-center py-3 text-xl">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.rum sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.rum
                        </p>
                    </div>
                </div>
