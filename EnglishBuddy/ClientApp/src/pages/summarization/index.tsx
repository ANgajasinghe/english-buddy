...
import SummarizationQuestion from './components/SummarizationQuestion'
import SummarizationEvaluation from './components/SummarizationEvaluation'
import SummarizationCorrections from './components/SummarizationCorrections'
...
export default function Summarization(props: {
  ...
  return (
    <div>
      <div>
        <SummarizationQuestion title={props.activity.title}
        ...
        loaded && (
          <div>
            <div className='mt-5 bg-secondary py-5 px-3 rounded-3xl'>
              <SummarizationEvaluation results={results}/>
            </div>
            <div className='my-5 bg-blue-100 py-5 px-3 rounded-3xl'>
              <SummarizationCorrections results={results}/>
            </div>
          </div>
        )
      }
